...
Exercise:
    1. Remove the UsersApiResponse and ProductsApiResponse types and 
    use the generic ApiResponse type to specify a generic API response format for each function. 
